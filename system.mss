...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = camera_interface_AXI_GammaCorrection_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = mipicsiss
 PARAMETER DRIVER_VER = 1.1
 PARAMETER HW_INSTANCE = camera_interface_mipi_csi2_rx_subsyst_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = preimproc
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = preimproc_0
END
...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = uart_sync_memory_interface_axi_gpio_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = gpio
 PARAMETER DRIVER_VER = 4.3
 PARAMETER HW_INSTANCE = uart_sync_memory_interface_axi_gpio_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axivdma
 PARAMETER DRIVER_VER = 6.5
 PARAMETER HW_INSTANCE = zynqmp_system_axi_vdma_0
END
